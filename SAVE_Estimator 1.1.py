...
while True:
    ...
    payment = 0
    if family == 1:
        payment = round((total_income - 32805) / 120, 2)
        if payment <= 0:
            payment = 0
        ...
        payment = round((total_income - 44370) / 120, 2)
        if payment <= 0:
            payment = 0
            print("Your estimated monthly payment on the SAVE Plan is $" + str(payment) + ".\n")
        else:
        ...
        payment = round((total_income - 55935) / 120, 2)
        if payment <= 0:
            payment = 0
            print("Your estimated monthly payment on the SAVE Plan is $" + str(payment) + ".\n")
        else:
        ...
        payment = round((total_income - 67500) / 120, 2)
        if payment <= 0:
            payment = 0
            print("Your estimated monthly payment on the SAVE Plan is $" + str(payment) + ".\n")
        else:
        ...
        payment = round((total_income - 79065) / 120, 2)
        if payment <= 0:
            payment = 0
            print("Your estimated monthly payment on the SAVE Plan is $" + str(payment) + ".\n")
        else:
        ...
        payment = round((total_income - 90630) / 120, 2)
        if payment <= 0:
            payment = 0
            print("Your estimated monthly payment on the SAVE Plan is $" + str(payment) + ".\n")
        else:
        ...
        payment = round((total_income - 102195) / 120, 2)
        if payment <= 0:
            payment = 0
            print("Your estimated monthly payment on the SAVE Plan is $" + str(payment) + ".\n")
        else:
        ...
        payment = round((total_income - 113760) / 120, 2)
        if payment <= 0:
            payment = 0
            print("Your estimated monthly payment on the SAVE Plan is $" + str(payment) + ".\n")
        else:
        ...
        payment = round((total_income - 125325) / 120, 2)
        if payment <= 0:
            payment = 0
            print("Your estimated monthly payment on the SAVE Plan is $" + str(payment) + ".\n")
        else:
        ...
        payment = round((total_income - 136890) / 120, 2)
        if payment <= 0:
            payment = 0
            print("Your estimated monthly payment on the SAVE Plan is $" + str(payment) + ".\n")
        else:
        ...
        payment = round((total_income - 148455) / 120, 2)
        if payment <= 0:
            payment = 0
            print("Your estimated monthly payment on the SAVE Plan is $" + str(payment) + ".\n")
        else:
        ...
        payment = round((total_income - 160020) / 120, 2)
        if payment <= 0:
            payment = 0
            print("Your estimated monthly payment on the SAVE Plan is $" + str(payment) + ".\n")
        else:
